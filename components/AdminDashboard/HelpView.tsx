  ...
  const steps = [
    {
      ...
      details: [
        ...
        "First, create Categories for organizing your questions",
        "For each category, select a Criterion Type (this is required):",
        "  • Required Minimum: Some students MUST have this skill in every group (e.g., at least 40% speak French)",
        "  • Balance Evenly: Make sure all groups have about the same amount of people with this skill",
        "  • Maximize in Groups: Try to put students with lots of skill from this category together",
        ...
        "Every question must be assigned to a category",
        "The algorithm uses these categories and their criterion types to form balanced groups",
      ],
    ...
    },
    {
      ...
      details: [
        ...
        "Select 'Assign Now (CP-SAT)' to run the assignment algorithm",
        "The algorithm uses your category criterion types to form groups:",
        "  • Required Minimum categories ensure groups meet skill requirements",
        "  • Balance Evenly categories distribute students fairly across groups",
        "  • Maximize categories group students with similar strengths together",
        "The system optimally assigns students to topics based on preferences and your criteria",
