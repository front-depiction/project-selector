...
const links = [
    ...
    {
        title: 'Contact',
        href: 'mailto:support@topicmatch.com',
    },
]
        ...
        <footer className="bg-muted py-16">
            <div className="mx-auto max-w-5xl px-6">
                ...
                <div className="my-8 flex flex-wrap justify-center gap-6">
                    ...
                    <LoginButton variant="link" className="text-muted-foreground hover:text-primary h-auto p-0 duration-150" />
                </div>
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} TopicMatch. All rights reserved.</span>
            </div>
        </footer>
    )
}
