                ...
                <div className="p-6">
                    <div>
                        ...
                        <h1 className="mt-6 text-balance text-xl font-semibold">
                            <span className="text-muted-foreground">Welcome back, Educator</span> Sign in to manage your project selection periods
                        </h1>
                    </div>
                ...
                <div className="px-6">
                    <p className="text-muted-foreground text-sm">
                        ...
                        <Button
                            ...
                            variant="link"
                            className="px-2">
                            <Link href="#">Create your teacher account</Link>
                        </Button>
                    </p>
                </div>
            </form>
